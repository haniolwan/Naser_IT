            ...
            <div className="services-page-container" data-aos="fade-down">
                ...
                <div className="heading-text">
                    ...
                    <p>
                        ...
                        <span className="home-link" onClick={() => navigate('/services')}>Services</span>
                        <img className="right-arrow" src={rightArrowImg} alt="SP.png" />
                        {title}
                    </p>
                </div>
            ...
            <Container className="mt-5">
                ...
                <Row className="services-process-section">
                    <div className="process-section">
                        ...
                        <p className="services-subtext">Great websites add great values to your business. From wire-framing to
                            PSD designing, we do it all.</p>
                    </div>
