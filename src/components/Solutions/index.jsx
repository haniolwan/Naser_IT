        ...
        <Row className="services-content">
          <Col>
            ...
            <ServiceCard
              ...
              title="App App Interface Makeover"
              details="Our UI designers can give your app's interface the facelift it needs to boost your sales,
                            especially during these uncertain times."
              classes="first-service-img"
            />
            ...
            <ServiceCard
              ...
              details="We have a specialized team with great experience in Testing software using the best tools"
              classes="forth-service-img"
            />
          </Col>
          <Col>
            {/* Second Card */}
            <ServiceCard
              ...
              details="We offer A-Z solutions for all your website needs!
                            Boost your business performance with the best website it deserves!"
              classes="second-service-img"
            />
            {/* Fifth Card */}
            <ServiceCard
              ...
              details="NASER IT application maintenance is a support service that ensures the stability of software
                            applications and IT systems."
              classes="fifth-service-img"
            />
          </Col>
          <Col>
            {/* Third Card */}
            <ServiceCard
              ...
              blob={(
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="119px" height="80px">
                  <path
                    className="icon-bg-shape third-blob"
              ...
              details="It is an application development service for Android or IOS devices,
                            using the code Native or Native Cross Platfrom such as flutter"
              classes="third-service-img"
            />
            {/* Sixth Card */}
            <ServiceCard
              ...
              details="We provide technical consulting services to help technology companies
                            overcome any problems that require much experience"
              classes="sixth-service-img"
            />
          </Col>
        </Row>
      </Container>
